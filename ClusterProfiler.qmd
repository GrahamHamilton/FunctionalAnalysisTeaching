...
## Load Previous Session Results {.smaller}

Read in the results file from Session 4
...
kegg_pathview <- function(kegg_pathway_id){
  pathview(gene.data = gsea_gene_list, # List of DE gene entrez ids and log fold changes
